...
class CoreNeopixel: public Machine {
 ...
 public:
  ...
  CoreNeopixel( void ) : Machine() {};
  CoreNeopixel& begin( CoreSettings* cSet );
  CoreNeopixel& trace( Stream & stream );
  CoreNeopixel& trigger( int event );
  int state( void );
  CoreNeopixel& onArm( Machine& machine, int event = 0 );
  CoreNeopixel& onArm( atm_cb_push_t callback, int idx = 0 );
  CoreNeopixel& onArmed( Machine& machine, int event = 0 );
  CoreNeopixel& onArmed( atm_cb_push_t callback, int idx = 0 );
  CoreNeopixel& onClash( Machine& machine, int event = 0 );
  CoreNeopixel& onClash( atm_cb_push_t callback, int idx = 0 );
  CoreNeopixel& onDisarm( Machine& machine, int event = 0 );
  CoreNeopixel& onDisarm( atm_cb_push_t callback, int idx = 0 );
  CoreNeopixel& onNextcolor( Machine& machine, int event = 0 );
  CoreNeopixel& onNextcolor( atm_cb_push_t callback, int idx = 0 );
  CoreNeopixel& onRecharge( Machine& machine, int event = 0 );
  CoreNeopixel& onRecharge( atm_cb_push_t callback, int idx = 0 );
  CoreNeopixel& onSwing( Machine& machine, int event = 0 );
  CoreNeopixel& onSwing( atm_cb_push_t callback, int idx = 0 );
  CoreNeopixel& idle( void );
  CoreNeopixel& recharge( void );
  CoreNeopixel& arm( void );
  CoreNeopixel& armed( void );
  CoreNeopixel& swing( void );
  CoreNeopixel& clash( void );
  CoreNeopixel& disarm( void );
