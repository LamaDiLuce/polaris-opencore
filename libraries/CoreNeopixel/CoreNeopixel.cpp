...
CoreNeopixel& CoreNeopixel::begin(CoreSettings* cSet) {
  // clang-format off
...
void CoreNeopixel::action( int id ) {
  switch ( id ) {
    case ENT_IDLE:
      turnOff();
...
void CoreNeopixel::turnOff()
{
  changeColor({0,0,0,0});
}

String CoreNeopixel::decodeColorSetId(int colorSetId)
{
...
void CoreNeopixel::getCurrentColorSet()
{
  ...
  CoreLogging::writeLine("CoreNeopixel: Color Set: %s", decodeColorSetId(currentColorSetId));
}

void CoreNeopixel::setCurrentColorSet(int colorSetId)
{
  CoreLogging::writeLine("CoreNeopixel: Setting color set...");
...
{
  CoreLogging::writeLine("CoreNeopixel: FadeIn");
...
void CoreNeopixel::fadeOut()
{
  CoreLogging::writeLine("CoreNeopixel: FadeOut");
...
void CoreNeopixel::pulse(const ColorLed& cLed)
{
...
CoreNeopixel& CoreNeopixel::trigger( int event ) {
...
CoreNeopixel& CoreNeopixel::idle() {
  trigger( EVT_IDLE );
  return *this;
}

CoreNeopixel& CoreNeopixel::recharge() {
  trigger( EVT_RECHARGE );
  return *this;
}

CoreNeopixel& CoreNeopixel::arm() {
  trigger( EVT_ARM );
  return *this;
}

CoreNeopixel& CoreNeopixel::armed() {
  trigger( EVT_ARMED );
  return *this;
}

CoreNeopixel& CoreNeopixel::swing() {
  trigger( EVT_SWING );
  return *this;
}

CoreNeopixel& CoreNeopixel::clash() {
  trigger( EVT_CLASH );
  return *this;
}

CoreNeopixel& CoreNeopixel::disarm() {
  trigger( EVT_DISARM );
  return *this;
}

void CoreNeopixel::reset_color_timer()
{
  timer_color_selection.setFromNow(this,TIME_FOR_START_COLOR_SELECTION);
}
...
CoreNeopixel& CoreNeopixel::onArm( Machine& machine, int event ) {
  onPush( connectors, ON_ARM, 0, 1, 1, machine, event );
  return *this;
}

CoreNeopixel& CoreNeopixel::onArm( atm_cb_push_t callback, int idx ) {
...
CoreNeopixel& CoreNeopixel::onArmed( Machine& machine, int event ) {
  onPush( connectors, ON_ARMED, 0, 1, 1, machine, event );
  return *this;
}

CoreNeopixel& CoreNeopixel::onArmed( atm_cb_push_t callback, int idx ) {
...
CoreNeopixel& CoreNeopixel::onClash( Machine& machine, int event ) {
  onPush( connectors, ON_CLASH, 0, 1, 1, machine, event );
  return *this;
}

CoreNeopixel& CoreNeopixel::onClash( atm_cb_push_t callback, int idx ) {
...
CoreNeopixel& CoreNeopixel::onDisarm( Machine& machine, int event ) {
  onPush( connectors, ON_DISARM, 0, 1, 1, machine, event );
  return *this;
}

CoreNeopixel& CoreNeopixel::onDisarm( atm_cb_push_t callback, int idx ) {
...
CoreNeopixel& CoreNeopixel::onNextcolor( Machine& machine, int event ) {
  onPush( connectors, ON_NEXTCOLOR, 0, 1, 1, machine, event );
  return *this;
}

CoreNeopixel& CoreNeopixel::onNextcolor( atm_cb_push_t callback, int idx ) {
...
CoreNeopixel& CoreNeopixel::onRecharge( Machine& machine, int event ) {
  onPush( connectors, ON_RECHARGE, 0, 1, 1, machine, event );
  return *this;
}

CoreNeopixel& CoreNeopixel::onRecharge( atm_cb_push_t callback, int idx ) {
...
CoreNeopixel& CoreNeopixel::onSwing( Machine& machine, int event ) {
  onPush( connectors, ON_SWING, 0, 1, 1, machine, event );
  return *this;
}

CoreNeopixel& CoreNeopixel::onSwing( atm_cb_push_t callback, int idx ) {
...
CoreNeopixel& CoreNeopixel::trace( Stream & stream ) {
  Machine::setTrace( &stream, atm_serial_debug::trace,
    "CoreNeopixel\0EVT_IDLE\0EVT_RECHARGE\0EVT_ARM\0EVT_ARMED\0EVT_SWING\0EVT_CLASH\0EVT_DISARM\0ELSE\0IDLE\0RECHARGE\0ARM\0ARMED\0CLASH\0SWING\0DISARM" );
  return *this;
}
